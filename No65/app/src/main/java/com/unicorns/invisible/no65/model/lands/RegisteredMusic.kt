...
class RegisteredMusic {
    companion object {
        val locationToMusic = HashMap<String, (LandsManager) -> Int>(mapOf(
            ...
            "map_fst_sf5_new" to { R.raw.location_fst },
            "map_fst_sf5_5" to { R.raw.location_fst_2 },
            "map_fst_sf6" to { R.raw.location_fst_2 },
            "map_fst_sf7" to { R.raw.location_fst_2 },
            ...
            "map_fst_wm0" to { R.raw.location_fst_3 },
            "map_fst_wm1" to { R.raw.location_fst_3 },
            "map_fst_wm2" to { R.raw.location_fst_3 },
            "map_fst_wm3" to { R.raw.location_fst_3 },
