...
class EventRevCh1LeftSocket : EventPlaced(lambda@ { manager ->
    if (REVOLUTION_CHOICE1_RIGHT_SOCKET_FIRED in manager.gameState.flagsMaster) {
    ...
    manager.wrapCutsceneSkippable {
        ...
        gameState.flagsMaster.add(REVOLUTION_CHOICE1_LEFT_SOCKET_FIRED)
    }
}) {
