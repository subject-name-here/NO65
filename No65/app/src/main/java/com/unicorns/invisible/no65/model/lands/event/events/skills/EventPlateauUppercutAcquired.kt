...
class EventPlateauUppercutAcquired(bookCell: SkillBook): EventSkillAcquired(bookCell) {
    override val skillNameId: Int
        get() = R.string.skills_plateau_uppercut_name
    override val effectDescriptionId: Int
        get() = R.string.skills_plateau_uppercut_description
